...
from Picmic_SC_UI_COMPIL import Ui_MainWindow   # GUI made with QTDesigner, and compiled with pyuic5
...
#import sc_picmic_highlevelfunc_14 as sc_p0_hlf   # High level functions for the slow control for picmic
...
if ((platform.release() != 'XP')and(ANALOG_DISCOVERY_DISABLED == False)):
    ...
    #import mod_pm0_AD2_11 as AD2  # for the DAC caracterisation
...
class Picmic_SC_GUI_Class (QMainWindow ): 
    ...
    def __init__(self):
        ...
        #Set Button
        self.ui.Set_Vpulse.clicked.connect(self.Set_Vpulse_Clicked)
   
        #Reset button
        self.ui.Reset_Vpulse.clicked.connect(self.Reset_Vpulse_Clicked)
        
        #ResetAll Button
        self.ui.ResetAll_Vpulse.clicked.connect(self.ResetAll_Vpulse_Clicked)
        ...
        ########################################################################################################################
        ############################################ PARTIE PAGE DAC CARACTERISATION   #########################################
        ########################################################################################################################
        ...
        self.logger.info("GUI init ended")
    ...
    def TabPageChanged(self):
        ...
        """
        #self.logger.error("changing tab security disabled")
    ...
    # ALL CHECKBOXES FUNCTIONS for Pulsed Pixels
    ...
    # ALL CHECKBOXES FUNCTIONS for NOT Pulsed Pixels
    ...
    """
        ...
        Everything related to Test Structure Fcts is here
    """ 
    ...
    """
        ...
        Everything related to Pixel Conf Fcts is here
    """   
            
    def ResetPixelMatrixMemories(self):
        """
            Callback for the Reset Pixel matrix memories from the Pix conf tab from the Registers tab
        """
    ...
    def Radio_SelRow_Row_PixConf_Clicked(self) :
        ...
        if self.ui.Radio_SelRow_Row_PixConf.isChecked():
            ...
            #string_input_PixConfRow = '00' #this set the Sel all row bit on 
            self.byte_input_PixConfRow = 0
    ...
    def Radio_SelAllRow_Row_PixConf_Clicked(self) :
        ...
        if self.ui.Radio_SelAllRow_Row_PixConf.isChecked():
            ...
            #string_input_PixConfRow = '80' #this set the Sel all row bit on 
    ...
    """
        ...
        Everything related to DAC 0-4 and DAC Switch Fcts is here
    """  
    #Set/Get buttons DAC 0-4
    ...
    """
        ...
        Everything related to VPulseSwitch Fcts is here
    """    
    ...
    def CarDacActivateStepByStep(self):
        """
            Callback for the step by step Caracterisation checkbox  of the Carac dac tab
        """
    ...
    def ADPSetParams(self):
        """
            Callback for the Set params button for the Analog Discovery in the Carac dac tab
        """
        if platform.release() != 'XP':
    ...
    def RunCaracterisation(self):
        """
            Callback for the Run Caracterisation button  of the Carac dac tab
        """
        if platform.release() != 'XP':
