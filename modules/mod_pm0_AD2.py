...
# modufié le 06 09 2022 par MS pour pourvoir l'utiliser avec un GUI 
import importlib
...
def FInit(ChannelA,ChannelB):
    ...
    dwf.FDwfAnalogInFrequencyGet(hdwf, VIntIn(VDoubleIn))
...
def FDualAcquisition(hdwf, ChannelA,ChannelB):
